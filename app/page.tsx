...
import { Lock, LogOut, Package, TrendingUp, TrendingDown, AlertCircle } from 'lucide-react'
import { Button, Input, Select, Card, Modal } from '@/components/ui'
import { supabaseApi } from '@/lib/supabase'
import { ProdutoComEstoque, MovimentacaoDetalhada, NovaMovimentacao, Usuario } from '@/types/database'
...
export default function EstoqueSystem() {
  // Estados principais
  ...
  const handleMovimentacao = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (movForm.tipo === 'SAIDA') {
        ...
        // ENTRADA - implementar lógica de criar novo lote ou somar ao existente
        ...
        // Aqui você implementaria a lógica de entrada
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <div className="text-center mb-6">
            <Lock className="mx-auto h-12 w-12 text-clinic-cyan mb-4" />
            <h2 className="text-2xl font-bold text-clinic-white">Clínica Ballarin</h2>
            <p className="text-clinic-gray-400 mt-1">Controle de Estoque</p>
          </div>
    ...
    <div className="min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <header className="flex justify-between items-center mb-8 pb-4 border-b border-clinic-gray-700">
          <div>
            <h1 className="text-3xl font-bold text-clinic-white">Controle de Estoque - Clínica Ballarin</h1>
            <p className="text-clinic-gray-400 mt-1">
              Registros por: <span className="font-semibold text-clinic-cyan">{currentUser?.nome_completo}</span>
                ...
                {selectedProduto && (
                  <div className="bg-clinic-gray-900 p-4 rounded-lg border border-clinic-gray-600">
                    ...
                    <div className="border-t border-clinic-gray-700 pt-4 space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span className="text-clinic-gray-400">Classe:</span>
                        <span className="text-clinic-white font-medium">{selectedProduto.classe_terapeutica}</span>
                      </div>
